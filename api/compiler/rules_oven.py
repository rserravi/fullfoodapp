    ...
    for s in steps:
        if s.action == "cook":
            ...
            plan.append(AppliancePlanStep(
                ...
                temperature_c=t,
                time_min=time,
                instructions=f"Hornea a {t}°C durante {time} min en bandeja centrada."
            ))
            ...
            plan.append(AppliancePlanStep(
                ...
                temperature_c=None,
                time_min=None,
                instructions="Abre, gira la bandeja o voltea piezas; retoma la cocción."
            ))
        elif s.action == "rest":
            plan.append(AppliancePlanStep(
                action="rest",
                temperature_c=None,
                time_min=s.time_min or 3,
                instructions="Deja reposar fuera del horno antes de servir."
            ))
        elif s.action == "serve":
            plan.append(AppliancePlanStep(
                action="serve",
